...
namespace Eclipse
{
    namespace Core
    {
        ...
        namespace Window
        {
            ...
            bool WindowShouldTerminate(Engine::Application* application)
            {
                ...
                if (Data::CORE.Window.currentContext)
                {
                    return (glfwWindowShouldClose(Data::CORE.Window.currentContext) && Data::CORE.Keyboard.exitKey != GLFW_PRESS) || application->m_shouldClose;
                }
    ...
    namespace External
    {
        ...
        namespace Debug
        {
            std::function<void(const std::string&, const std::string&, unsigned)> DebugAPI::Debug_Pointer = nullptr;
            std::function<void(const std::string&, const std::string&, unsigned)> DebugAPI::Error_Pointer = nullptr;
            std::function<void(const std::string&, const std::string&, unsigned)> DebugAPI::Log_Pointer = nullptr;
        }
